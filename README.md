...
The visualization is hosted on Fly.io, a web hosting service commonly used with NiceGUI. It only works with subway data, so I only have subway data in this repository. To run the interactive visualization, run main.py or visit https://the-ttc-improvement-game.fly.dev/.
